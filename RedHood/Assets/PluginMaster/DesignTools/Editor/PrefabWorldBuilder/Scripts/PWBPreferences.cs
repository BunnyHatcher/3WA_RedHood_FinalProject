            ...
            using (new GUILayout.HorizontalScope())
            {
                ...
                using (new GUILayout.VerticalScope())
                {
                    ...
                    void ContextMenu(PWBShortcut shortcut, UnityEditor.GenericMenu.MenuFunction DisableFunction)
                    {
                        ...
                        menu.AddItem(new GUIContent("Disable shortcut"), false, DisableFunction);
                        menu.ShowAsContext();
                    }
                    ...
                    if (_pinCategory)
                    {
                        ...
                        MouseShortcutRow(PWBSettings.shortcuts.pinSelectNextItem, true);
                    ...
                    else if(_paletteCategory)
                    {
                        ...
                        MouseShortcutRow(PWBSettings.shortcuts.paletteNextBrush, true);
                        MouseShortcutRow(PWBSettings.shortcuts.paletteNextPalette, true);
                    }
